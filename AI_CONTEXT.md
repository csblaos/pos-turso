...
- Orders:
  ...
  - UX `/orders`:
    ...
    - layout ช่อง `จำนวน` กับ `ราคา` ใน item editor ของ PO ถูกล็อกความสูง label row ให้เท่ากันแล้วทั้ง create/edit เพื่อไม่ให้ input กระโดดตำแหน่งเวลาเปลี่ยนโหมด `ต่อหน่วย / ยอดรวมรายการ` หรือเมื่อ label ฝั่งราคา wrap หลายบรรทัด
