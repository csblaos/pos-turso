...
- Orders:
  ...
  - UX `/orders`:
    ...
    - `PO detail modal` บน mobile ปรับ header actions ใหม่แล้ว: badge สถานะบังคับ `single-line`, และ action `บันทึกชำระ / อัปเดตค่าขนส่ง / ปิดเรท / แก้ไข` จะ stack เต็มความกว้างบนมือถือแทนการเบียดในแถวเดียว; พอขึ้น `sm+` ค่อยกลับไปเป็นปุ่มแนวนอน/ห่อบรรทัด
