...
import { ChevronRight, Settings2, Store, Truck, WalletCards } from "lucide-react";
...
export default async function SettingsStoreFinancePage() {
  ...
  if (!canView) {
    return (
      <section className="space-y-3">
        <h1 className="text-xl font-semibold">{t(uiLocale, "settings.link.storeFinance.title")}</h1>
