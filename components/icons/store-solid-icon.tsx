...
// Custom filled store icon (SVG path provided by the project team).
// Note: The original SVG comment references Font Awesome Pro; ensure licensing is handled by the project.
export const StoreSolidIcon = forwardRef<SVGSVGElement, LucideProps>(function StoreSolidIcon(
  props,
  ref,
) {
  const { color = "currentColor", size = 24, className, absoluteStrokeWidth, ...rest } = props;
